  ...
  <div class="flex justify-center  gap-3 p-1 md:p-6">
    <div class="w-full md:w-3/5 flex justify-center flex-col items-center gap-6">
      ...
      <div class="flex space-x-4">
          ...
          <!-- CV Button -->
          <a href="https://drive.google.com/file/d/1GR_0YQvwBfAjHalFIGKdKAHx0VZ5uQwn/view?usp=sharing" target="_blank" class="group relative p-0 md:p-3 block w-fit cursor-pointer">
