    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        <div class="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div class="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
                ...
                <span class="text-white/90 truncate">HookScope</span>
            </div>
        </div>
        <div class="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div class="space-y-6 md:space-y-10 animate-slideInLeft">
                <div class="space-y-4 md:space-y-6">
                    <h1 class="text-3xl md:text-6xl font-bold bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight pb-3">HookScope</h1>
                ...
                <div class="prose prose-invert max-w-none">
                    <p class="text-base md:text-lg text-gray-300/90 leading-relaxed">Create custom endpoints, capture incoming requests, and inspect every detail in real-time. Perfect for testing and debugging webhooks.</p>
                </div>
                    ...
                    <div class="flex flex-wrap gap-2 md:gap-3">
                        <div class="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 cursor-default">
                            ...
                            <div class="relative flex items-center gap-1.5 md:gap-2">
                                ...
                                <span class="text-xs md:text-sm font-medium text-blue-300/90 group-hover:text-blue-200 transition-colors">Next JS</span>
                            </div>
                        </div>
                        <div class="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 cursor-default">
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition-all duration-500"></div>
                    ...
                    <h3 class="text-xl font-semibold text-white/90 flex items-center gap-3">
                        ...
                        <ul class="list-none space-y-2">
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
                                ...
                                <span class="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors text-start">Generate custom webhook endpoints instantly with unique IDs</span>
                            </li>
                            ...
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
                                ...
                                <span class="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors text-start">View headers, body, query params, and timestamps in real-time</span>
                            </li>
                            ...
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
                                ...
                                <span class="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors text-start">Organize, filter, and delete requests with an intuitive dashboard</span>
                            </li>
