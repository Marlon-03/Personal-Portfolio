    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        <div class="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div class="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
                ...
                <span class="text-white/90 truncate">Pizza</span>
            </div>
        </div>
        <div class="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div class="space-y-6 md:space-y-10 animate-slideInLeft">
                <div class="space-y-4 md:space-y-6">
                    <h1 class="text-3xl md:text-6xl font-bold bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight pb-3">Pizza</h1>
                ...
                <div class="prose prose-invert max-w-none">
                    <p class="text-base md:text-lg text-gray-300/90 leading-relaxed">Simple static landing page website built with HTML, CSS and Javascript. It is fully responsive and mobile friendly. I got idea of the site from a food website and decided to build it.</p>
                </div>
                <div class="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
                    ...
                    <div class="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-blue-500/20 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg">
                        ...
                        <div class="flex-grow"><div class="text-lg md:text-xl font-semibold text-blue-200">3</div>
                    ...
                    <div class="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-purple-500/20 transition-all duration-300 hover:scale-105 hover:border-purple-500/50 hover:shadow-lg">
                        ...
                        <div class="flex-grow">
                            <div class="text-lg md:text-xl font-semibold text-purple-200">2</div>
                            <div class="text-[10px] md:text-xs text-gray-400">Key Features</div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap gap-3 md:gap-4">
                    <a href="https://marlon-03.github.io/Pizza/" target="_blank" rel="noopener noreferrer" class="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-blue-600/10 to-purple-600/10 hover:from-blue-600/20 hover:to-purple-600/20 text-blue-300 rounded-xl transition-all duration-300 border border-blue-500/20 hover:border-blue-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base">
                    ...
                    <a href="https://github.com/Marlon-03/Pizza" target="_blank" rel="noopener noreferrer" class="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-purple-600/10 to-pink-600/10 hover:from-purple-600/20 hover:to-pink-600/20 text-purple-300 rounded-xl transition-all duration-300 border border-purple-500/20 hover:border-purple-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base">
            ...
            <div class="space-y-6 md:space-y-10 animate-slideInRight">
                <div class="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                    ...
                    <img src="../assets/pizza.png" alt="Pizza" class="w-full  object-cover transform transition-transform duration-700 will-change-transform group-hover:scale-105">
                    ...
                    <h3 class="text-xl font-semibold text-white/90 flex items-center gap-3">
                        ...
                        <ul class="list-none space-y-2">
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
                                ...
                                <span class="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors text-start"> Uses CSS media queries to adapt to different screen sizes</span>
                            </li>
                            ...
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
                                ...
                                <span class="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors text-start">Optimized performance with minimal dependencies</span>
                            </li>
