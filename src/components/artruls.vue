        ...
        <div class="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div class="space-y-6 md:space-y-10 animate-slideInLeft">
                ...
                <div class="prose max-w-none">
                    <p class="text-base md:text-lg text-[#4B5563] leading-relaxed">Inspired by the museum of modern art, this is a simple static landing page website built with HTML, CSS and Bootstrap. It is fully responsive and mobile friendly.</p>
                </div>
                <div class="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#FBF7F1] rounded-2xl overflow-hidden relative border border-[#E8DDC8]">
                    ...
                    <div class="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white p-2 md:p-3 rounded-xl border border-[#E8DDC8] transition-all duration-300 hover:scale-105 hover:border-[#1A2B56]/20 hover:shadow-lg">
                        ...
                        <div class="flex-grow">
                            <div class="text-lg md:text-xl font-semibold text-[#1A2B56]">2</div>
                    ...
                    <div class="flex flex-wrap gap-2 md:gap-3">
                        ...
                        <div class="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-[#FBF7F1] rounded-xl border border-[#E8DDC8] hover:border-[#1A2B56]/20 transition-all duration-300 cursor-default shadow-sm">
                            ...
                            <div class="relative flex items-center gap-1.5 md:gap-2">
                                ...
                                <span class="text-xs md:text-sm font-medium text-[#1A2B56] group-hover:text-[#13213C] transition-colors">HTML 5</span>
                            </div>
                        </div>
                        <div class="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-[#FBF7F1] rounded-xl border border-[#E8DDC8] hover:border-[#1A2B56]/20 transition-all duration-300 cursor-default shadow-sm">
                            <div class="absolute inset-0 bg-gradient-to-r from-[#E3B65B]/0 to-[#1A2B56]/0 group-hover:from-[#E3B65B]/20 group-hover:to-[#1A2B56]/10 transition-all duration-500"></div>
                            <div class="relative flex items-center gap-1.5 md:gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package w-3.5 h-3.5 md:w-4 md:h-4 text-[#1A2B56] group-hover:text-[#13213C] transition-colors"><path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"></path><path d="M12 22V12"></path><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"></path><path d="m7.5 4.27 9 5.15"></path></svg>
                                <span class="text-xs md:text-sm font-medium text-[#1A2B56] group-hover:text-[#13213C] transition-colors">CSS 3</span>
                            </div>
                        </div>
                        <div class="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-[#FBF7F1] rounded-xl border border-[#E8DDC8] hover:border-[#1A2B56]/20 transition-all duration-300 cursor-default shadow-sm">
                            <div class="absolute inset-0 bg-gradient-to-r from-[#E3B65B]/0 to-[#1A2B56]/0 group-hover:from-[#E3B65B]/20 group-hover:to-[#1A2B56]/10 transition-all duration-500"></div>
                    ...
                    <h3 class="text-xl font-semibold text-[#13213C] flex items-center gap-3">
                        ...
                        <ul class="list-none space-y-2">
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-[#F3EBDD] transition-all duration-300 border border-transparent hover:border-[#E8DDC8]">
                                ...
                                <span class="text-sm md:text-base text-[#4B5563] group-hover:text-[#13213C] transition-colors text-start">Uses Bootstrap's responsive grid system and utility classes to adapt to different screen sizes.</span>
                            </li>
                            ...
                            <li class="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-[#F3EBDD] transition-all duration-300 border border-transparent hover:border-[#E8DDC8]">
                                ...
                                <span class="text-sm md:text-base text-[#4B5563] group-hover:text-[#13213C] transition-colors text-start">Optimized performance with minimal dependencies</span>
                            </li>
                        </ul>
                </div>
            </div>
